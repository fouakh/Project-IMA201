...
def main():
    ...
    image_paths_2 = [
        "Images_Lab_GW_+_Eqalization/EX_image001.jpg",
        "Images_Lab_GW_+_Eqalization/EX_image002.jpg",
        "Images_Lab_GW_+_Eqalization/EX_image010.png",
        "Images_Lab_GW_+_Eqalization/EX_image016.png"
    ]
    ...
    for i in range(4):
        ...
        axes[1, i].set_title(f"Image Lab Gray World & Equalization {i+1}", fontsize=8)
        axes[1, i].axis("off")
